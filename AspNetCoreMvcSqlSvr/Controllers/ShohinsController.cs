...
namespace AspNetCoreMvcSqlSvr.Controllers
{
    public class ShohinsController : Controller
    {
        ...
        {
            if (_context.Shohin == null)
            {
                return Problem("エンティティ セット 'MvcShohinContext.Shohin' が null です。");
            }
            ...
            //return _context.Shohin != null ? 
            //            View(await _context.Shohin.ToListAsync()) :
            //            Problem("エンティティ セット 'MvcShohinContext.Shohin' が null です。");
        }

        // GET: Shohins/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            if (id == null || _context.Shohin == null)
            {
                return NotFound();
            }
        ...
        {
            shohin.EditDate = decimal.Parse(String.Format(DateTime.Now.ToString("yyyyMMdd")));
            shohin.EditTime = decimal.Parse(String.Format(DateTime.Now.ToString("HHmmss")));
        ...
        {
          return (_context.Shohin?.Any(e => e.NumId == id)).GetValueOrDefault();
        }
    }
}
